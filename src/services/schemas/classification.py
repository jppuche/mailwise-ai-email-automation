...
class ClassificationServiceResult(BaseModel):
    ...
    Distinct from the adapter ClassificationResult (B04) and the ORM
    ClassificationResult (B01). This is the business-level result that
    includes heuristic context.
    """
