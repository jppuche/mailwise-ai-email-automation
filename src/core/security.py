...
with specific exception types per try-except D7.

tighten-types D1: TokenPayload is TypedDict, not dict[str, Any].
...
def verify_password(plain_password: str, hashed_password: str) -> bool:
    ...
    D8: local computation — uses conditional return only.
    """
...
def verify_access_token(token: str) -> TokenPayload:
    ...
    try-except D7: separate catches per exception type.
