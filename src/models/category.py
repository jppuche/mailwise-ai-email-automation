...
configurability without redeployment. This enforces pre-mortem Cat 3:
classification results FK to category rows, making it impossible for an LLM
hallucination to write a free-form string that bypasses validation.
