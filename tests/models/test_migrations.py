...
class TestMigrationUpgrade:
    ...
    def test_upgrade_creates_email_state_enum(self, sync_engine: Engine) -> None:
        ...
        pre-mortem Cat 1: DB-level ENUM prevents invalid state values
...
class TestForeignKeyEnforcement:
    ...
    pre-mortem Cat 3 (stringly-typed): Even if Python code bypasses ORM
    validation, the DB must reject invalid category IDs. This is the
    architectural guarantee that prevents corrupted classification results.
    """
