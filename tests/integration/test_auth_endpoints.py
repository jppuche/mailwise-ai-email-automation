...
Tests use conditionals (assert) not try/except — response parsing is local
computation over known shapes.
"""
...
class TestMeEndpoint:
    ...
    async def test_me_with_expired_token(
        ...
        try/except ExpiredSignatureError — a structured external-state check
        on the jose library's parsing result.
        """
        settings = get_settings()
