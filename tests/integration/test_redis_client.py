...
Tests verify the error-surface by monkeypatching _get_redis to inject
...
class TestRedisErrorHandling:
    ...
    Verifies that set_refresh_token / get_refresh_token / delete_refresh_token
    catch ConnectionError and TimeoutError and raise RedisClientError.
