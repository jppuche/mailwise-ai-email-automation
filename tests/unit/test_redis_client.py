...
try-except D7: structured exceptions — ConnectionError and TimeoutError
handled separately, not as bare except Exception.
"""
...
class TestSetRefreshToken:
    ...
    async def test_connection_error_raises_redis_client_error(self) -> None:
        """RedisConnectionError wraps to RedisClientError (try-except D7)."""
    ...
    async def test_timeout_error_raises_redis_client_error(self) -> None:
        """RedisTimeoutError wraps to RedisClientError (try-except D7)."""
