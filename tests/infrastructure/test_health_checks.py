...
class TestComposeFileStructure:
    ...
    def test_images_pinned_to_patch_version(self) -> None:
        """All Docker images have pinned patch versions."""
        content = COMPOSE_PATH.read_text(encoding="utf-8")
    ...
    def test_healthcheck_intervals_use_env_vars(self) -> None:
        ...
        Validates that load-bearing defaults are configurable without an image
        rebuild — operators set HEALTHCHECK_INTERVAL etc.
        """
        content = COMPOSE_PATH.read_text(encoding="utf-8")
    ...
    def test_known_images_are_pinned(self) -> None:
        """Specific image tags required by the deployment spec are present."""
        content = COMPOSE_PATH.read_text(encoding="utf-8")
    ...
    def test_scheduler_command_is_correct(self) -> None:
        ...
        Known bug fix — regression guard.
        """
        content = COMPOSE_PATH.read_text(encoding="utf-8")
    ...
    def test_api_healthcheck_path_is_correct(self) -> None:
        ...
        Known bug fix: was /health, corrected to /api/v1/health.
        """
        content = COMPOSE_PATH.read_text(encoding="utf-8")
