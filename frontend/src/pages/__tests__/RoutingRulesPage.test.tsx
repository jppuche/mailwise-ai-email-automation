...
describe("RoutingRulesPage", () => {
  ...
  it("toggle checkbox is checked for active rule", () => {
    renderPage();
    const toggle = screen.getByRole("checkbox", { name: /toggle slack routing rule active/i });
    expect(toggle).toBeChecked();
  });

  it("toggle checkbox is unchecked for inactive rule", () => {
    renderPage();
    const toggle = screen.getByRole("checkbox", { name: /toggle email escalation rule active/i });
  ...
  it("shows loading state when rules are loading", () => {
    ...
    renderPage();
    expect(screen.getByText(/loading routing rules/i)).toBeInTheDocument();
  });
