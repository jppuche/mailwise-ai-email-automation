...
//
// pre-mortem Cat 8: REVIEW_QUEUE_POLL_PAGE_SIZE is a named constant, not a magic number.
 ...
 *
 * Pre-mortem Cat 4: confidence precondition — the backend (B08) returns a string
 * enum "high" | "low". If this ever changes to a float, the badge will silently
 * show nothing. Validated by tsc against ClassificationSummary.confidence type.
 */
 ...
 *
 * Pre-mortem Cat 8: REVIEW_QUEUE_POLL_PAGE_SIZE is a named constant (50).
