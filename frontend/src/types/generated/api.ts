...
//
// This file is a PLACEHOLDER matching the actual backend schemas.
...
export interface components {
  schemas: {
    ...
    // ----------------------------------------------------------------
    // Emails (src/api/schemas/emails.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Drafts (src/api/schemas/drafts.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Categories (src/api/schemas/categories.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Few-shot examples (src/api/schemas/categories.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Integrations (src/api/schemas/integrations.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Routing Rules (src/api/routers/routing_rules.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Analytics (src/api/routers/analytics.py)
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // Integrations — additional configs
    // ----------------------------------------------------------------
    ...
    // ----------------------------------------------------------------
    // System Logs (src/api/routers/logs.py)
    // ----------------------------------------------------------------
...
/** Convenience alias for EmailFilter — used by email list components */
